 ...
 * @param countryCode - ISO 3166-1 alpha-2 country code (e.g., "AT", "DE")
...
export function getCountryName(countryCode: string): string {
  ...
  return COUNTRY_CODE_TO_NAME[upperCode] || countryCode;
}

/**
 * Check if a string is a valid country code
 * @param code - String to check
 * @returns true if it's a valid 2-letter country code
 */
export function isCountryCode(code: string): boolean {
  ...
  return COUNTRY_CODE_TO_NAME.hasOwnProperty(code.toUpperCase());
}